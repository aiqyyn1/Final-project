...
$stmt = $pdo->prepare('SELECT * FROM products where cat = "mystery" ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM products where cat = "mystery"')->rowCount();
?>
