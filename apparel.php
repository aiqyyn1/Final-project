...
$stmt = $pdo->prepare('SELECT * FROM products where cat = "apparel" ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM products where cat = "apparel"')->rowCount();
?>
