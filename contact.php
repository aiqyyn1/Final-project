...
<main>
    <div class="contact">
        <div class="contact-text">
            ...
            <br>
            <p>Should you have any questions or concerns that aren't answered on our <a href="REpolicy.html">Return &
                    Exchange Policy</a> or
                <a href="faq.hml">FAQ</a> pages, please use the following form to email our dedicated support team!</p>
            <br>
            <p>Please remember that our hours of operation for shipping and customer service are <b>Monday through
                    Friday,
                    8AM to 4PM PST</b> (<i>excluding weekends and major holidays</i>) with response times typically
                within
                1-2 business
                days. Please allow an extra 1-2 business days for a response during high traffic times such as holidays
                and new launches.</p>
            <br>
            <p>Lastly please note that <b>we answer all emails oldest to newest</b>, so <b><i>each new email will move
                        you back to the end of the queue!</i></b></p>
            <br>
            <form action="contact.php" method="post">
                <input autocomplete="false" name="name" placeholder="Name" required type="text">
                <br>
