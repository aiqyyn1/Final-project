...
<main>
    <div class="faq">
        ...
        <br>
        <br>
        <p><b>What is Killer Merch and what does it have to do with Ketnipz? </b></p>
        <br>
        <p>Killer Merch is a full service merchandise company that Ketnipz and other artists/brands use to design,
            manufacture, and ship their products to fans and companies world wide. You will notice products come
            directly from the Killer Merch warehouse, which is also home to our talented customer service team at
            customerservice@ketnipz.com.</p>
        <br>
        <p>We help artists and brands create amazing merchandise for both their individual web stores and retail stores-
            we even handle tour merchandise for live event needs! We handle all aspects of merchandise production, so
            your favorite artists and brands can focus on developing fresh, creative ideas for you! Visit us at
            <a href="https://www.killermerch.com/">www.killermerch.com</a> for more info on our family of stores. </p>
        <br>
        <p><b>How long does shipping take?</b></p>
        <p>Our hours of operation for both shipping and customer service are Monday through Friday, 8 a.m. to 4 p.m.
            PST, excluding weekends and major USA holidays. <b>Orders will ship 1-2 business day after you order. This
                does not include the time spent in transit!</b></p>
        <br>
        <p><i>*NOTE: during new releases, holidays, etc. there can be an additional 2-4 business days of processing
                time.</i></p>
        <br>
        <p>Transit times will vary based upon a few different conditions, including but not limited to:</p>
        <ul>
            <li>Total distance between us and you</li>
            <li>Whether your parcel is a domestic (USA) or international (everywhere else) shipment</li>
            <li>What delivery method you select</li>
        </ul>
        <br>
        <p>ESTIMATED transit times are as follows. Please note that this time frame is an estimate and not a
            guarantee.</p>
        <br>
        <p><b>DOMESTIC:</b></p>
        <ul>
            <li>DHL eCommerce: 3-8 business days ($100 insurance included)</span></li>
            <li>USPS First Class: 7-10 business days (Hawaii, Alaska, U.S. Territories Only)</span></li>
            <li>USPS Priority Mail: 5-7 business days (Hawaii, Alaska, U.S. Territories Only; $100 worth of insurance
                included)</span></li>
            <li>UPS Ground: 2-5 business days ($100 insurance included)</span></li>
            <li>UPS 2nd Day Air: 2 business days ($100 insurance included)</span></li>
        </ul>
        <br>
        <p><b>INTERNATIONAL</b> (Does NOT account for time spent at customs, border inspection facilities, etc):</p>
        <ul>
            <li>DHL eCommerce International: 7-13 business days ($100 insurance included)</li>
            <li>DHL eCommerce International Priority: 4-12 business days ($100 insurance included)</li>
            <li>UPS Worldwide Expedited: 2-5 business days ($100 insurance included)</li>
        </ul>
        <br>
        <p><b>How much is shipping?</b></p>
        <p>All shipping rates will vary depending on a few different factors, some of which include:</p>
        <ul>
            <li>Domestic vs International shipments</li>
            <li>Total weight of package</li>
            <li>Selected shipping method</li>
        </ul>
        <br>
        <p><b>We ARE NOT RESPONSIBLE for ANY fees required by customs for any reason.</b> All shipping fees we require will be
            clearly shown to you alongside the service and estimated transit time upon checkout.</p>
    </div>
</main>
<footer>
